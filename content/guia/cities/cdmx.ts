    ...
    'Centro': {
      ...
      spots: {
        es: [
          ...
          { icon: 'landmark',   name: 'Templo Mayor',            distance: 'Seminario 8, a un costado de la Catedral', note: 'El corazón de Tenochtitlan a cielo abierto, con el monolito de Coyolxauhqui en su museo; cierra lunes, como casi todo el Centro.' },
          { icon: 'landmark',   name: 'Palacio de Bellas Artes', distance: 'Av. Juárez, esq. Eje Central', note: 'Los murales de Rivera y Siqueiros bajo la cúpula; el museo cierra lunes, la fachada nunca.' },
          { icon: 'cross',      name: 'El Moro',                 distance: 'Eje Central 42', note: 'Churros y chocolate desde 1935, abierto toda la noche; el final correcto de cualquier noche en el Centro.' },
        ...
        en: [
          ...
          { icon: 'landmark',   name: 'Templo Mayor',            distance: 'Seminario 8, a un costado de la Catedral', note: 'The heart of Tenochtitlan in open air, with the Coyolxauhqui monolith in its museum; closed Mondays, like most of downtown.' },
          { icon: 'landmark',   name: 'Palacio de Bellas Artes', distance: 'Av. Juárez, esq. Eje Central', note: 'Rivera and Siqueiros murals under the dome; the museum closes Mondays, the facade never does.' },
          { icon: 'cross',      name: 'El Moro',                 distance: 'Eje Central 42', note: 'Churros and chocolate since 1935, open all night; the correct ending to any night downtown.' },
