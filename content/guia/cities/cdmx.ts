    ...
    'Centro': {
      ...
      spots: {
        es: [
          ...
          { icon: 'landmark',   name: 'Palacio de Bellas Artes', distance: 'en el Centro', note: 'Los murales de Rivera y Siqueiros bajo la cúpula; el museo cierra lunes, la fachada nunca.' },
        ...
        en: [
          ...
          { icon: 'landmark',   name: 'Palacio de Bellas Artes', distance: 'in the Centro', note: 'Rivera and Siqueiros murals under the dome; the museum closes Mondays, the facade never does.' },
