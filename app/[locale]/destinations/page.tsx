/**
 * app/[locale]/destinations/page.tsx — Stub
 * Route ES: /destinationsIndex  (see i18n.ts pathnames for full localized segment)
...
export async function generateMetadata({
  ...
  const alternates = buildAlternates(locale, 'destinationsIndex')
  return {
    title:       locale === 'es' ? 'Destinos' : 'Destinations',
    alternates,
