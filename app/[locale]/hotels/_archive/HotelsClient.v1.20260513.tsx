'use client'
// ARCHIVED — Hotels client v1, parked on 2026-05-13
// Reason: Hotels redesign (see components/hotels/HotelsClient.tsx for v2)
// Safe to delete after 30 days if v2 is stable in prod.
// Import path adjusted to keep type-check working from inside the
// archive directory.
