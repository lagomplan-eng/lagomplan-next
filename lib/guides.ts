...
const GUIDES: Guide[] = [
  {
    ...
    destination_es: 'Valle de Bravo',
    destination_en: 'Valle de Bravo',
...

  {
    ...
    destination_es: 'Riviera Maya',
    destination_en: 'Riviera Maya',
...

  {
    ...
    destination_es: 'Cuernavaca',
    destination_en: 'Cuernavaca',
  ...
  // ── Cancún ─────────────────────────────────────────────
  {
    ...
    destination_es: 'Cancún',
    destination_en: 'Cancún',
  ...
  // ── Guadalajara ────────────────────────────────────────
  {
    ...
    destination_es: 'Guadalajara',
    destination_en: 'Guadalajara',
  ...
  // ── Los Cabos ──────────────────────────────────────────
  {
    ...
    destination_es: 'Los Cabos',
    destination_en: 'Los Cabos',
  ...
  // ── Mérida ─────────────────────────────────────────────
  {
    ...
    destination_es: 'Mérida',
    destination_en: 'Mérida',
  ...
  // ── Puerto Vallarta ────────────────────────────────────
  {
    ...
    destination_es: 'Puerto Vallarta',
    destination_en: 'Puerto Vallarta',
  ...
  // ── San Miguel de Allende ──────────────────────────────
  {
    ...
    destination_es: 'San Miguel de Allende',
    destination_en: 'San Miguel de Allende',
  ...
  // ── Tepoztlán ──────────────────────────────────────────
  {
    ...
    destination_es: 'Tepoztlán',
    destination_en: 'Tepoztlán',
  ...
  // ── Tulum ──────────────────────────────────────────────
  {
    ...
    destination_es: 'Tulum',
    destination_en: 'Tulum',
