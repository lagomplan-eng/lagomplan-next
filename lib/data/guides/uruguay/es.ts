  ...
  hotels: [
    {
      ...
      affiliateUrl: 'https://www.booking.com/hotel/uy/radisson-colonia-del-sacramento-casino.es-mx.html?aid=356980&label=gog235jc-10CAso7QFCJnJhZGlzc29uLWNvbG9uaWEtZGVsLXNhY3JhbWVudG8tY2FzaW5vSFJYA2igAYgBAZgBM7gBB8gBDNgBA-gBAfgBAYgCAagCAbgC27Gx0AbAAgHSAiQyMmFmMGNlYS1iZDg0LTQzMjAtOTg0Ny1kYjNlNGMxOGMxMGPYAgHgAgE&sid=ce3990bc71d7c5bd11b7b98f41809970&age=1&all_sr_blocks=28692323_93723986_2_2_0&checkin=2026-06-23&checkout=2026-06-26&dest_id=-906319&dest_type=city&dist=0&group_adults=2&group_children=0&hapos=1&highlighted_blocks=28692323_93723986_2_2_0&hpos=1&matching_block_id=28692323_93723986_2_2_0&no_rooms=1&req_adults=2&req_children=0&room1=A%2CA&sb_price_type=total&sr_order=popularity&sr_pri_blocks=28692323_93723986_2_2_0__34000&srepoch=1779194094&srpvid=803e586ecc8a043d&type=total&ucfs=1&',
      archetypes: ['Familias'],
    },
    {
      ...
      affiliateUrl: 'https://booking.stay22.com/lagomplan/faoDPjW2Ew',
      archetypes: ['Familias'],
    },
    {
      name: 'Posada Boutique Las Terrazas',
      type: 'Hotel · Montevideo · Barrio Histórico',
      priceTier: '$$',
      description: 'Posada boutique solar a una cuadra del Barrio Histórico, la distancia justa para llegar al Faro caminando sin estar dentro del circuito turístico. Habitaciones con balcón y vistas al río, sala común con chimenea y piedra expuesta, desayuno buffet casero y una copa de licor de bienvenida diferente cada noche. El detalle que más aparece en los reviews: el personal que orienta, da recomendaciones y hace que una estadía de dos días se sienta como quedarse en casa de alguien que conoce bien su ciudad. Bicicletas disponibles para explorar Colonia sin auto. ',
      tag: 'A una cuadra del centro histórico',
      affiliateUrl: 'https://booking.stay22.com/lagomplan/GtMMFtydBC',
      archetypes: ['Familias'],
    },
  ],
