...
export const guide: FlatGuide = {
  ...
  hotels: [
    ...
    },
    {
      ...
      type: 'Hotel · San Pedro de Atacama',
      priceTier: '$$',
      description: 'Desayuno buffet incluido, WiFi gratis y ubicación a 300 metros de la calle Caracoles — la arteria principal del pueblo. Habitaciones con capacidad para cuatro personas. El hotel tiene un detector de temperatura y oxígeno en recepción por la altitud — un detalle que tranquiliza a los padres con niños pequeños. Administración familiar y personal que conoce todas las agencias de tours locales. Precio estimado: $70–110 USD/noche habitación familiar.',
      tag: 'Familiar y con detalles para la altitud',
      affiliateUrl: '',
      archetypes: ['Familias'],
    },
    {
