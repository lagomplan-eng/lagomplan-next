...
export const guide: FlatGuide = {
  ...
  hotels: [
    ...
    },
    {
      ...
      priceTier: '$$$',
      description: 'One minute on foot from the Glico Man sign and Dotonbori, right on Midosuji — the city\'s main boulevard. The only hotel in the area with a bathtub in every room, a gym, a bar-lounge, and a buffet breakfast with both Japanese and Western options. Rooms run considerably larger than Osaka\'s standard. It also holds a sustainability certification. For the couple who wants to live the city from the inside: Dotonbori, Shinsaibashi, and Kuromon Market are all under a ten-minute walk. Estimated price: $120–280 USD/night.',
      tag: 'The only hotel with a bathtub in every room, a minute from Dotonbori',
