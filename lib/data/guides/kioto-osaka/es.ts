  ...
  hotels: [
    {
      ...
      affiliateUrl: 'https://www.booking.com/searchresults.html?ss=Hotel+The+Celestine+Kyoto+Gion%2C+Kyoto%2C+Kyoto%2C+Japan&aid=1607597&label=v4.cmubi59l408iy01ro9unze3vu&dest_id=2183021&dest_type=hotel',
      archetypes: ['Parejas'],
    },
    {
      name: 'Gion Shinmonso',
    ...
    },
    {
      ...
      type: 'Hotel · Shinsaibashi, Osaka',
      priceTier: '$$$',
      description: 'Un minuto a pie del Glico Man y el Dotonbori, sobre la Midosuji (principal boulevard de la ciudad). El único hotel de la zona con tina en cada habitación, gimnasio, bar-lounge y desayuno buffet con opciones japonesas y occidentales. Las habitaciones son considerablemente más amplias que el estándar de Osaka. Además, opera con un certificado de sostenibilidad. Para la pareja que quiere vivir la ciudad desde adentro: Dotonbori, Shinsaibashi y el Kuromon Market todos a menos de diez minutos caminando. Precio estimado: $120–280 USD/noche.',
      tag: 'El único hotel con tina en cada habitación, a un minuto del Dotonbori',
      affiliateUrl: 'https://www.booking.com/searchresults.html?ss=Cross+Hotel+Osaka',
      archetypes: ['Parejas'],
    },
  ],
