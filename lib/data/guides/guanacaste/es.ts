...
export const guide: FlatGuide = {
  ...
  hotels: [
    ...
    },
    {
      ...
      name: 'Capit[an Suizo Beachfront Boutique Hotel',
      type: 'Hotel · Frente al mar Bahía Tamarindo',
      priceTier: '$$$',
      description: 'Frente al mar en el extremo más tranquilo de la bahía de Tamarindo — a un kilómetro del centro, lo justo para no escuchar los altavoces del pueblo ni depender de él. Bungalows de madera entre jardines tropicales donde los monos aulladores aparecen por las mañanas sin previo aviso. Piscina con acceso directo a la playa, restaurante El Barco con mesas sobre la arena y desayuno buffet incluido. Desde 1992 en el mismo lugar, sin haber necesitado renovarse para mantenerse como referencia del corredor. Para el grupo que quiere la playa sin el ruido.Precio estimado: $180–320 USD/noche por habitación.',
      tag: 'Frente al mar en el extremo más tranquilo',
      affiliateUrl: 'https://booking.stay22.com/lagomplan/xwSkTk6GWZ',
      archetypes: ['Parejas'],
    },
  ],
