...
export const guide: FlatGuide = {
  ...
  hotels: [
    ...
    },
    {
      ...
      type: 'Hotel Boutique · Antigua',
      priceTier: '$$$',
      description: 'El primer hotel boutique de estilo europeo en Antigua — desde 1986 y sin necesidad de reinventarse. Nueve suites con chimenea alrededor de un jardín colonial con fuente. El restaurante, con mesas bajo bóvedas y carta de vinos seria, es considerado uno de los mejores del país. Desayuno incluido. A cuatro cuadras del Parque Central.',
      tag: 'Uno de los mejores del país',
      affiliateUrl: 'https://booking.stay22.com/lagomplan/C6_K1iudtq',
      archetypes: ['Parejas', 'Bienestar'],
    },
  ],
