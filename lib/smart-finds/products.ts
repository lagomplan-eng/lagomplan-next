...
export const PRODUCTS: Record<string, Product> = {
  ...
  'doona-car-seat-stroller': {
    ...
    price:   '$15,000–20,000 MXN · $870–1,160 USD',
  ...
  'gb-pockit-all-city': {
    ...
    price:   '$4,000–5,000 MXN · $230–290 USD',
    where:   'Amazon MX',
  ...
  'ergobaby-omni-breeze': {
    ...
    price:   '$2,000–3,000 MXN · $115–175 USD',
    where:   'Amazon MX',
  ...
  'mia-mily-cabin-suitcase': {
    ...
    price:   '$5,000–6,000 MXN · $290–350 USD',
    where:   'Amazon MX',
  ...
  'apple-airtag-4pack': {
    ...
    price:   '$1,500–2,000 MXN · $87–116 USD',
    where:   'Amazon MX',
