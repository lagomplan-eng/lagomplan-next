...
export const es: CityGuide = {
  ...
  stayNeighborhoods:{
    intro:"Houston es una ciudad enorme y sin zonificación urbana estricta — lo que la hace difícil de orientar a primera vista. La clave para el fan mundialista: quedarse en el corredor que conecta el centro con el Medical Center y el NRG Stadium, servido por el METRORail.",
    items:[
      { kind:"recommended", title:"Base recomendada: Midtown Houston / Museum District", body:"El Midtown de Houston combina acceso directo al METRORail (estaciones McGowen y Wheeler en la línea Roja, que va al estadio) con la mayor concentración de restaurantes y bares de la ciudad por kilómetro cuadrado. El Museum District, contiguo, tiene el corredor de museos más denso del sur de Estados Unidos y hoteles boutique a precios más razonables que el Downtown. Al estadio en METRORail: 12 minutos directos." },
      { kind:"alternative", title:"Opción con carácter: Montrose", body:"El barrio más ecléctico e independiente de Houston: galerías de arte, cafeterías de especialidad, librerías de segunda mano y la escena de restaurantes más interesante de la ciudad. Conecta con el METRORail por la estación Wheeler (línea Roja). Para el fan que quiere el Houston real entre partidos de Alemania y Portugal." },
      { kind:"alternative", title:"Para fans de Portugal y comunidad latinoamericana: Mahatma Gandhi District / Westheimer", body:"El corredor de Westheimer en el suroeste de Houston tiene la mayor concentración de restaurantes latinoamericanos, del Medio Oriente y del sur de Asia de la ciudad. La comunidad portuguesa de Houston, aunque pequeña, tiene sus puntos de reunión aquí. Para el fan de Portugal que quiere comer, beber y ver los partidos rodeado de gente que entiende lo que está pasando." },
      { kind:"avoid", title:"Evitar como base: Downtown Houston", body:"El downtown de Houston es funcional para negocios y tiene buenos hoteles de cadena, pero muere a las 6pm. Sin vida de barrio, sin restaurantes informales accesibles caminando, sin bares de partido con atmósfera. El METRORail sale desde aquí al estadio, pero no hay razón para quedarse en el centro si Midtown o Montrose están a diez minutos." },
    ],
  },
  stays:[
    { name:"Hotel Zaza Houston", area:"Museum District / Montrose", price:"$$$", priceCAD:"$220–400 USD/noche (periodo mundialista)", tags:["Boutique","Piscina","Museum District"], note:"El hotel más personalidad de Houston: habitaciones temáticas, piscina con cabañas y un restaurante que funciona para el desayuno previo al partido de mediodía y la cena de celebración de la noche. Tres cuadras del METRORail en la estación Museum District.", best_for:"Carácter", url:"https://booking.stay22.com/lagomplan/2aSmYzQyvT", archetypes: ['Parejas'] },
    { name:"Rusk House", area:"Downtown", price:"$$", priceCAD:"Precio estimado en periodo mundialista: $180–280 USD/noche por apartamento de 1 habitación.", tags:["Apartamentos","Cocina","METRORail cerca"], note:"Aparthotel en el downtown con cocina completa, sala propia y room service. Para estadías de varios días con partido incluido, el formato de apartamento gana al hotel estándar en precio real y comodidad.", best_for:"Presupuesto", url:"https://www.booking.com/hotel/us/rusk-house-serviced-apartments.html?label=New_English_EN_MX_26638589545-ZSp669YmWn_cQudvrv7xhAS634117824864%3Apl%3Ata%3Ap1%3Ap2%3Aac%3Aap%3Aneg%3Afi%3Atidsa-64415538625%3Alp9047093%3Ali%3Adec%3Adm%3Aag26638589545%3Acmp393949225%3Acid393949225%3Aagid26638589545&sid=5482c8ec2d7466f81e7d743629f44e7a&gclid=CjwKCAjwzevPBhBaEiwAplAxvs3jGoIYPSWlvcssp7F4kojhKlKAsEv8tgTqCMSI1i-31OoYRqYgOhoCUI0QAvD_BwE&aid=318615", archetypes: [] },
    { name:"Post Oak Hotel at Uptown Houston", area:"Galleria / Uptown", price:"$$$$", priceCAD:"$480–900 USD/noche (periodo mundialista)", tags:["Lujo","Spa","Uptown"], note:"El hotel de lujo más ambicioso abierto en Houston en la última década: dos restaurantes de Michelin, spa de 3,500 metros cuadrados y la mejor vista al skyline de Uptown. Para la noche de la Ronda de 16 del 4 de julio — el partido del mediodía da tiempo a llegar al hotel antes del atardecer.", best_for:"Lujo", url:"https://www.booking.com/hotel/us/the-post-oak.html", archetypes: ['Parejas'] },
  ],
...
export const en: CityGuide = {
  ...
  stayNeighborhoods:{
    intro:"Houston is enormous and has no strict urban zoning — which makes it hard to orient at first glance. The key for the World Cup fan: stay in the corridor connecting downtown with the Medical Center and NRG Stadium, served by METRORail.",
    items:[
      { kind:"recommended", title:"Recommended base: Midtown Houston / Museum District", body:"Houston's Midtown combines direct METRORail access (McGowen and Wheeler stations on the Red Line, which reaches the stadium) with the city's highest density of restaurants and bars per square kilometer. The Museum District, adjacent, has the densest museum corridor in the southern U.S. and boutique hotels at more reasonable prices than Downtown. To the stadium on METRORail: 12 minutes direct." },
      { kind:"alternative", title:"Character pick: Montrose", body:"Houston's most eclectic and independent neighborhood: art galleries, specialty coffee, used bookstores, and the city's most interesting restaurant scene. Connects to METRORail via Wheeler Station (Red Line). For the fan who wants the real Houston between Germany and Portugal matches." },
      { kind:"alternative", title:"For Portugal fans and Latin American community: Mahatma Gandhi District / Westheimer", body:"The Westheimer corridor in southwest Houston has the city's highest concentration of Latin American, Middle Eastern, and South Asian restaurants. Houston's Portuguese community, though small, has its meeting points here. For the Portugal fan who wants to eat, drink, and watch matches surrounded by people who get what's happening." },
      { kind:"avoid", title:"Avoid as a base: Downtown Houston", body:"Downtown Houston is functional for business and has good chain hotels, but dies after 6pm. No neighborhood life, no walkable casual restaurants, no match-day bars with atmosphere. METRORail leaves from here to the stadium, but there's no reason to stay downtown when Midtown or Montrose are ten minutes away." },
    ],
  },
  stays:[
