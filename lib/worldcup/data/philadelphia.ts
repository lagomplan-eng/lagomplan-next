...
export const es: CityGuide = {
  ...
  stayNeighborhoods:{
    intro:"Filadelfia tiene la ventaja logística más clara de cualquier sede del torneo en la Costa Este: el estadio está en South Philadelphia, conectado al centro por el metro más directo del país, y el aeropuerto está a cinco kilómetros del estadio. La ciudad se orienta sola.",
    items:[
      { kind:"recommended", title:"Base recomendada: Center City / Rittenhouse Square", body:"El corazón del Philadelphia que el viajero quiere conocer. Rittenhouse Square tiene los mejores hoteles boutique de la ciudad, el acceso más directo al Broad Street Line (estación Walnut-Locust a tres cuadras de la plaza) y una concentración de restaurantes y bares que funciona bien antes y después del partido. Al estadio desde aquí: 20 minutos en metro, directo." },
      { kind:"alternative", title:"Opción con energía: Fishtown / Northern Liberties", body:"El corredor más activo de la nueva Filadelfia: bares con criterio, restaurantes de autor jóvenes, murales y una clientela que lleva una década haciendo de este barrio el más interesante de la ciudad. Más alejado del estadio (20 minutos en Uber o 30 en SEPTA), pero la mejor opción para el fan que quiere ver los partidos en un bar con atmosfera sin el ambiente corporativo del Center City." },
      { kind:"alternative", title:"Estrategia de presupuesto: South Philadelphia (cerca del estadio)", body:"El barrio italiano históricamente más importante de la ciudad, con casas adosadas, restaurantes de décadas de historia y una distancia al estadio que se puede hacer a pie en 30 minutos o en el Broad Street Line en 10. Para el fan que prioriza la cercanía al recinto y tiene varios partidos, South Philly tiene Airbnbs bien ubicados a precios más razonables que el Center City." },
    ],
  },
  stays:[
    { name:"The Rittenhouse Hotel", area:"Rittenhouse Square / Center City", price:"$$$$", priceCAD:"$350–580 USD/noche (periodo mundialista)", tags:["Hotel boutique","Spa","Broad Street Line"], note:"El hotel de referencia de Filadelfia desde los 90: vistas a la plaza, spa, restaurante de nivel y habitaciones que no necesitan actualizar el diseño porque el clásico funciona. A tres cuadras del Broad Street Line y a veinte minutos del estadio en metro.", best_for:"Carácter", url:"https://booking.stay22.com/lagomplan/MyXircbGCg", archetypes: ['Parejas', 'Bienestar'] },
    { name:"Apple Hostels of Philadelphia", area:"Old City / Cristo Rey", price:"$", priceCAD:"$60–130 USD/noche según tipo de habitación", tags:["Presupuesto","Zona histórica","Cerca Liberty Bell"], note:"El hostal más bien valorado de Filadelfia, en el barrio histórico a dos cuadras del Liberty Bell y del Independence Hall. Habitaciones privadas y compartidas, cocina comunitaria y terraza con vistas. Para el viajero con presupuesto que quiere la ciudad, no solo el partido.", best_for:"Presupuesto", url:"https://booking.stay22.com/lagomplan/jMbVoUSYQC", archetypes: ['Solo'] },
    { name:"Four Seasons Philadelphia", area:"Center City / Comcast Tower", price:"$$$$", priceCAD:"$650–1,100 USD/noche (periodo mundialista)", tags:["Piso 57","Vistas al Schuylkill","Jean-Georges"], note:"En el piso 57 del rascacielos más alto de Filadelfia — la única dirección de la ciudad con vistas completas al río Schuylkill y al Delaware. Piscina en el piso 57, restaurante Jean-Georges Vongerichten y acceso a todas las líneas de SEPTA desde el nivel de calle.", best_for:"Lujo", url:"https://booking.stay22.com/lagomplan/1ZZSzLZttO", archetypes: ['Parejas'] },
  ],
...
export const en: CityGuide = {
  ...
  stayNeighborhoods:{
    intro:"Philadelphia has the clearest logistical advantage of any East Coast host city: the stadium is in South Philadelphia, connected to the center by the country's most direct subway, and the airport is five kilometers from the stadium. The city orients itself.",
    items:[
      { kind:"recommended", title:"Recommended base: Center City / Rittenhouse Square", body:"The heart of the Philadelphia the traveler wants to know. Rittenhouse Square has the city's best boutique hotels, the most direct access to the Broad Street Line (Walnut-Locust Station three blocks from the square), and a concentration of restaurants and bars that work well before and after the match. From here to the stadium: 20 minutes on the metro, direct." },
      { kind:"alternative", title:"For energy: Fishtown / Northern Liberties", body:"The most active corridor of new Philadelphia: thoughtful bars, young chef-driven restaurants, murals, and a clientele that has spent a decade making this the city's most interesting neighborhood. Farther from the stadium (20 minutes by Uber or 30 by SEPTA), but the best option for the fan who wants to watch matches in a bar with atmosphere, away from Center City's corporate vibe." },
      { kind:"alternative", title:"Budget strategy: South Philadelphia (near the stadium)", body:"The historically most important Italian neighborhood in the city, with rowhouses, restaurants with decades of history, and a stadium distance you can walk in 30 minutes or take the Broad Street Line in 10. For the fan who prioritizes stadium proximity and has multiple matches, South Philly has well-located Airbnbs at more reasonable prices than Center City." },
    ],
  },
  stays:[
