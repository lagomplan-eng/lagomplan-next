...
export const es: CityGuide = {
  ...
  stays:[
    { name:"The Line Hotel", area:"Koreatown / Mid-City", price:"$$$", priceCAD:"$200–350 USD/noche (periodo mundialista)", tags:["Diseño","Restaurante de autor","Metro Vermont-Beverly"], note:"El hotel con más personalidad del corredor de Koreatown: arquitectura de los años 60 reformada, restaurantes de Roy Choi y acceso al metro Red Line (Vermont-Beverly a 5 min a pie). Desde ahí, shuttle o Uber al SoFi en 20 minutos. La mejor combinación de carácter y logística mundialista.", best_for:"Carácter", hotel_link:"https://booking.stay22.com/lagomplan/6sr9_HBZR0" },
    { name:"Freehand Los Angeles", area:"Downtown LA / Koreatown", price:"$$", priceCAD:"$120–250 USD/noche (periodo mundialista)", tags:["Smart value","Bar de referencia","Metro cerca"], note:"El hotel de referencia para el viajero con criterio y presupuesto calibrado. Bar en el rooftop, habitaciones privadas bien diseñadas y acceso al metro Red Line desde Wilshire/Vermont. La opción más honesta del torneo para quien quiere ciudad y no solo precio.", best_for:"Smart value", hotel_link:"https://expedia.stay22.com/lagomplan/9h1rXGSH11" },
    { name:"The West Hollywood Edition", area:"West Hollywood / Sunset Strip", price:"$$$$", priceCAD:"$600–1,200 USD/noche (periodo mundialista)", tags:["Lujo","Piscina en techo","Sunset Strip"], note:"La dirección más impresionante del torneo en Los Ángeles: piscina de diseño con vistas al Hollywood Sign, restaurante del chef John Fraser y ambiente de quienes vienen a LA a hacer algo importante. Para el partido inaugural, la imagen del 12 de junio en West Hollywood no tiene equivalente en ninguna otra sede.", best_for:"Lujo", hotel_link:"https://hotelscom.stay22.com/lagomplan/idtJtZYsk8" },
  ],
  logistics:{
    transport:[
