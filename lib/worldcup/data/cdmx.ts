...
export const es: CityGuide = {
  ...
  manifesto:{
    stadiumInfo:[
      ...
      { label:"Aeropuerto alternativo",value:"AIFA — Felipe Ángeles (ZMO), Santa Lucía, Estado de México — a ~80 km del estadio. Solo si tu vuelo opera desde ahí." },
    ],
  ...
  stayNeighborhoods:{
    intro:"La Ciudad de México tiene 21 millones de personas y 16 alcaldías. Elegir bien el barrio base no es un capricho editorial — es una decisión logística que puede hacer o deshacer tu Mundial.",
    items:[
  ...
  stays:[
    { name:"Ignacia Guest House", area:"Roma Norte", price:"$$$", priceCAD:"Precio estimado en periodo mundialista: $200–320 USD/noche", tags:["Boutique","Casona porfiriana","11 habitaciones"], note:"Once habitaciones en una casona porfiriana restaurada. Sin lobby monumental, sin conserje corporativo: diseño serio, jardín interior y una ubicación que pone al huésped a una cuadra de los mejores restaurantes de la ciudad.", best_for:"Hotel boutique", url:"https://hotelscom.stay22.com/lagomplan/-3nIgm0dd7", archetypes: ['Familias', 'Parejas'] },
    { name:"Casa Pancha", area:"Condesa", price:"$", priceCAD:"Precio estimado en periodo mundialista: $350–700 MXN/noche en dorm · $900–1,400 MXN/noche habitación privada.", tags:["Presupuesto","Habitaciones privadas","Terraza comunitaria"], note:"Hostal de diseño boho en la Condesa. 34 cápsulas, habitación privada disponible, desayuno incluido y terraza. A 400 metros del metro Juanacatlán. El lugar donde llegas solo y te vas con planes para cenar con otros cinco.", best_for:"Presupuesto", url:"https://www.booking.com/hotel/mx/casa-pancha.en-gb.html?aid=311984;label=casa-pancha-qr5FUVzaQcZpvBZDCGjYkgS589529709806:pl:ta:p1:p2:ac:ap:neg:fi:tiaud-2393881721446:kwd-2063469257222:lp9047093:li:dec:dm:ppccp=UmFuZG9tSVYkc2RlIyh9YV19IumoQ3O51m4Ge68sOW8;ws=&gad_source=1&gad_campaignid=426265382&gbraid=0AAAAAD_Ls1IcaFOGqsfF87H_5NQE-Pz6x&gclid=CjwKCAjwzevPBhBaEiwAplAxvv-Hcx1UO4NXKQx8uQCPB49LkQQ5tzZuT4bbZtQlub3W-J3OxkaxgRoCa38QAvD_BwE", archetypes: [] },
    { name:"St. Regis Mexico City", area:"Paseo de la Reforma", price:"$$$$", priceCAD:"Precio estimado en periodo mundialista: $400–700 USD/noche", tags:["Vista a Chapultepec","Metro Insurgentes","Reforma"], note:"Vista directa al Bosque de Chapultepec y a la Columna de la Independencia. Acceso rápido al Metro Insurgentes. Uno de los hoteles con mejor relación posición-servicio de la ciudad.", best_for:"Lujo", url:"https://booking.stay22.com/lagomplan/dDSl_dn7B8", archetypes: ['Parejas'] },
  ],
  ...
  food:[
    { dish:"La Polar (Azcapotzalco / Cantina) 🍺",         where:"Cantina histórica de 1938 con ambiente de tribuna y clientela que sabe de fútbol. El menú de botanas sin cargo — chicharrón, cacahuates enchilados, quesadillas — viene incluido con el consumo de cervezas. Las pantallas llevan años transmitiendo Liga MX y partidos internacionales. Para el partido de México, La Polar es el estadio alterno de la ciudad. Qué pedir: Cerveza de barril + orden de quesadillas. Vibe: Cantina clásica mexicana, sin filtros turísticos.", price:"$", type:"Cantina histórica" },
    { dish:"Salón Corona (Centro Histórico / Cantina) 🍻", where:"Desde 1928, esta cantina del centro transmite todo lo que se puede transmitir. Pantallas en cada rincón, cerveza de barril, botanas sin cargo y acceso al Metro Zócalo para llegar al Fan Fest sin rodeos. La clientela mezcla oficinistas del centro con turistas que acaban de descubrir que existe una cantina mejor que cualquier cosa en su país. Qué pedir: Tostadas de pata + lo que haya de barril. Vibe: Ciudad de México sin filtro, siempre con partido en pantalla.", price:"$", type:"Cantina histórica" },
    { dish:"El Paisa (Condesa / Bar de barrio) 🌮",        where:"Bar de barrio con terrazas exteriores y pantallas orientadas a la calle. En días de partido de México o de la UEFA, la terraza de El Paisa se convierte en el punto de reunión del vecindario de Condesa. Comida de pub mexicano honesta, precios más bajos que el promedio del barrio y una actitud que no intenta ser otra cosa de lo que es. Qué pedir: Tacos de canasta + michelada. Vibe: Condesa sin pretensiones, pantalla siempre activa.", price:"$", type:"Bar de barrio" },
  ],
  ...
  didYouKnow:"El Estadio Azteca es el único recinto del mundo que ha albergado dos finales de Copa del Mundo (1970 y 1986) y en 2026 se convierte en el primero en recibir tres ediciones del torneo.",
...
export const en: CityGuide = {
  ...
  manifesto:{
    ...
    body:"Mexico City doesn't travel to the World Cup — the World Cup returns to where it's always been. The Estadio Azteca hosted the 1970 and 1986 finals. In 2026 it becomes the only venue on the planet with three editions of the World Cup. On June 11 it also hosts the tournament's opening with around 72,000 people, Mexico at home, and the most charged atmosphere of any city in the tournament. The stadium knows the weight. The city does too.",
  ...
  stayNeighborhoods:{
    intro:"Mexico City has 21 million people and 16 boroughs. Picking the right base neighborhood isn't an editorial whim — it's a logistics decision that can make or break your World Cup.",
    items:[
      { kind:"recommended", title:"Recommended base: Condesa / Roma Norte", body:"The golden triangle of considered tourism in CDMX. Boutique hotels, markets, chef-driven restaurants, and direct Metro access. The trip to the Azteca from this area takes 45–55 minutes via Metro Line 1 (Insurgentes → Pino Suárez, transfer to Line 2 → Tasqueña, then the Light Rail to Estadio Azteca). It's the most reliable route on match day. The walk between the two neighborhoods is 15 minutes; they share a plaza, an atmosphere, and a price range." },
      { kind:"alternative", title:"A judgment call: Coyoacán",              body:"The bohemian southern neighborhood has an advantage few fans use: the Light Rail runs through it. Xotepingo station is less than two kilometers from Jardín Centenario. Staying in Coyoacán cuts the logistics to under 15 minutes to the Azteca. Lower prices than Condesa, more atmosphere than any chain hotel on Insurgentes." },
      { kind:"avoid",       title:"Avoid as a base: Around the stadium (Tlalpan / Santa Úrsula Coapa)", body:"The area immediately around the Azteca has very limited lodging and a service infrastructure that isn't ready to absorb 72,000 international fans. Convenient in theory, frustrating in practice." },
    ],
  },
  ...
  logistics:{
    ...
    matchDayCronologia:{
      ...
      steps:[
        ...
        { time:"H-1:00", text:"At the stadium. Gates open." },
  ...
  food:[
    { dish:"La Polar (Azcapotzalco / Cantina) 🍺",            where:"A historic cantina from 1938 with the atmosphere of a tribune and a crowd that knows football. The free botana menu — chicharrón, spiced peanuts, quesadillas — comes with your beers. The screens have broadcast Liga MX and international matches for years. On Mexico match days, La Polar is the city's second stadium. What to order: Draft beer + an order of quesadillas. Vibe: Classic Mexican cantina, no tourist filters.", price:"$", type:"Historic cantina" },
    { dish:"Salón Corona (Centro Histórico / Cantina) 🍻",    where:"Since 1928, this downtown cantina has broadcast everything broadcastable. Screens in every corner, draft beer, free botanas, and direct Metro Zócalo access to the Fan Fest. The crowd mixes downtown office workers with tourists who just realized a better cantina exists than anything back home. What to order: Tostadas de pata + whatever's on tap. Vibe: Mexico City unfiltered, always with the match on screen.", price:"$", type:"Historic cantina" },
    { dish:"El Paisa (Condesa / Neighborhood bar) 🌮",        where:"A neighborhood bar with street-facing terraces and screens angled toward the sidewalk. On Mexico or UEFA match days, the El Paisa terrace becomes the Condesa neighborhood's meeting point. Honest Mexican pub food, prices below the neighborhood average, and an attitude that doesn't try to be anything other than what it is. What to order: Tacos de canasta + michelada. Vibe: Condesa unpretentious, screens always on.", price:"$", type:"Neighborhood bar" },
  ],

  experiences:[
    { title:"Teotihuacán + National Museum of Anthropology", duration:"Full day", desc:"The Teotihuacán archaeological zone is 50 km northeast and reachable by bus from the Terminal del Norte in under an hour. Recommendation: arrive before 9am to skip the heat and tour groups. For the afternoon, the National Museum of Anthropology in Chapultepec holds the most complete pre-Hispanic archaeological collection on the continent — the Mexica Hall alone justifies the visit.", type:"Historic", affiliateLink:"https://getyourguide.stay22.com/lagomplan/s1vPPVVq1r", affiliateLabel:"See Teotihuacán tours" },
    { title:"Xochimilco + Coyoacán", duration:"Full day", desc:"Trajinera boat in the morning, Mercado de Coyoacán at midday, Frida Kahlo Museum in the afternoon (book online ahead — door access is always sold out). The Light Rail connects Coyoacán with central CDMX, which makes this the most logical off-day for anyone who also has a match at the Azteca.", type:"Cultural", affiliateLink:"https://getyourguide.stay22.com/lagomplan/s1vPPVVq1r", affiliateLabel:"Book Xochimilco boat" },
    { title:"Mercado de Jamaica + La Merced", duration:"Half day", desc:"Mercado de Jamaica is Mexico's largest wholesale flower market — arrive at dawn. La Merced is the commercial heart of the city's east side: loud, photogenic, rarely visited by international fans. Neither is on the standard itinerary. That's exactly why they're here.", type:"Local", affiliateLink:"https://getyourguide.stay22.com/lagomplan/s1vPPVVq1r", affiliateLabel:"CDMX market tours" },
    { title:"Bosque de Chapultepec", duration:"Morning or afternoon", desc:"Latin America's largest urban park wraps Chapultepec Castle across more than 680 hectares. The lake, the perimeter museums — Rufino Tamayo, Modern Art, Natural History — and the view of the Castle from the second section make Chapultepec the necessary breath between matches. Free on Sundays.", type:"City", affiliateLink:"https://getyourguide.stay22.com/lagomplan/s1vPPVVq1r", affiliateLabel:"Chapultepec cultural tours" },
  ],
  ...
  didYouKnow:"The Estadio Azteca is the only venue in the world to have hosted two World Cup finals (1970 and 1986), and in 2026 it becomes the first to host three editions of the tournament.",
