...
export const en: CityGuide = {
  ...
  experiences:[
    { title:"Whistler — day trip", duration:"Full day", desc:"The perfect halftime to understand why Vancouver has an immigration waiting list the World Cup isn't going to shrink. Two hours from Vancouver on the Sea-to-Sky Highway — one of the most spectacular roads in North America. In June, Whistler has alpine hiking, ziplines, the Whistler Mountain Bike Park, and glacier views. The Whistler Mountaineer bus runs from downtown Vancouver. For the fan with a full free day between June 13 and 18, there's no better excursion in the tournament.", type:"Day trip", affiliateLink:"AFFILIATE_LINK_WHISTLER", affiliateLabel:"See Whistler tours" },
    { title:"Deep Cove + Indian Arm — kayaking", duration:"Half day", desc:"30 minutes by car or private transport north of Vancouver, Deep Cove is a kayaking village on Indian Arm. Kayak and paddleboard rentals available by the hour or the day. The route into the fjord has calm waters, waterfalls, and views that explain why people pay $2 million to live nearby.", type:"Adventure", affiliateLink:"AFFILIATE_LINK_DEEPCOVE_KAYAK", affiliateLabel:"Book kayak in Deep Cove" },
    { title:"Stanley Park + English Bay", duration:"Morning or afternoon", desc:"The largest urban park in North America wraps the northern part of the Vancouver peninsula across 405 hectares of coastal forest. The Seawall bike route (22 km loop) runs the park's coastline with views of the Strait of Georgia. Bike rentals are available at English Bay and next to the park. At sunset, English Bay is the city's gathering point: the best place to watch the Pacific sunset before an evening match.", type:"City", affiliateLink:"AFFILIATE_LINK_STANLEY_PARK_BIKES", affiliateLabel:"Rent a bike at English Bay" },
    { title:"BC Place — the stadium before the match", duration:"1–2 hours", desc:"BC Place has a retractable roof and hosted the 2015 Women's World Cup Final. Arriving 90 minutes before kickoff isn't logistics — it's the show. The outdoor esplanade, False Creek a few steps away, and the North Shore mountains in the background are the pre-match photo.", type:"Must try", affiliateLink:"AFFILIATE_LINK_BCPLACE_TICKETS", affiliateLabel:"See available tickets" },
  ],
