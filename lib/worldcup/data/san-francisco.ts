...
export const es: CityGuide = {
  ...
  stays:[
    { name:"Hotel Zephyr", area:"San Francisco / Fisherman's Wharf", price:"$$$", priceCAD:"$280–480 USD/noche (periodo mundialista)", tags:["Boutique","Muelle histórico","Vistas a Alcatraz"], note:"En el muelle histórico de SF con vistas a la bahía y al Alcatraz, el Zephyr tiene habitaciones con diseño náutico-contemporáneo, patio exterior con fuegos artificiales y acceso al Embarcadero en 5 minutos a pie. Para el fan que quiere SF completo — con el entendimiento de que el estadio está a 70 km.", best_for:"SF completo", url:"https://booking.stay22.com/lagomplan/4eYFj7a3ys", archetypes: ['Parejas'] },
    { name:"Marriott San José", area:"Downtown San José", price:"$$", priceCAD:"$200–350 USD/noche (periodo mundialista)", tags:["Cerca Caltrain","Piscina","Downtown"], note:"Para el fan con varios partidos, el Marriott del downtown de San José tiene acceso al Caltrain (estación San José Diridon, a tres cuadras) y piscina. La opción más eficiente del triángulo SF–SJ–estadio.", best_for:"Varios partidos", url:"https://booking.stay22.com/lagomplan/niw-b1kZGi", archetypes: [] },
    { name:"Oakland Marriott City Center", area:"Downtown Oakland / Lake Merritt BART", price:"$$", priceCAD:"$160–280 USD/noche (periodo mundialista)", tags:["BART Lake Merritt","Económico","Mejor precio-posición"], note:"A una cuadra de la estación Lake Merritt del BART — que conecta con el centro de SF en 15 minutos y con la estación de Caltrain de Millbrae (para bajar al sur) en 40. El mejor precio-posición de la Bay Area para el fan que quiere opciones en ambas ciudades.", best_for:"Presupuesto", url:"https://booking.stay22.com/lagomplan/LWLsKjRLvN", archetypes: [] },
  ],
