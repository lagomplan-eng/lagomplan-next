...
export const es: CityGuide = {
  ...
  stayNeighborhoods:{
    intro:"Dallas es la sede con la mayor cantidad de partidos del torneo y el problema logístico más claro: el estadio está en Arlington, una ciudad completamente independiente entre Dallas y Fort Worth, sin metro, sin bus lanzadera oficial a escala ciudad. La elección del barrio base tiene que resolver el transporte de manera realista.",
    items:[
      { kind:"recommended", title:"Base recomendada: Uptown Dallas / Knox-Henderson", body:"Uptown es el barrio de más densidad gastronómica y hotelera de Dallas, con acceso al McKinney Avenue Trolley (tranvía gratuito que conecta con el Centro de Convenciones y el sistema de transporte DART). Desde Uptown a Arlington en Uber en día normal: 35–45 minutos. En día de partido con Uber surge: 50–70 minutos. Knox-Henderson, contiguo, tiene los mejores restaurantes independientes de la ciudad." },
      { kind:"alternative", title:"Opción táctica: Las Colinas / Irving", body:"Para el fan que prioriza acceso al estadio sobre ambiente urbano, Las Colinas e Irving están en el corredor entre DFW y Arlington — a 20 minutos del estadio en auto sin tráfico de partido. Hoteles de cadena bien equipados, acceso rápido al DFW por el DART Orange Line y un tramo más corto que Dallas centro en días de partido. Sin el ambiente de barrio de Uptown, pero sin el tráfico de regreso." },
      { kind:"alternative", title:"Para aficionados argentinos: Garland / Richardson (comunidad latinoamericana)", body:"El corredor de Garland Road y la Comunidad de Richardson tienen la mayor concentración de restaurantes latinoamericanos del área metropolitana — y una comunidad argentina que en días de partido convierte los bares del barrio en algo muy parecido a La Boca. El DART Blue Line conecta Richardson con el centro de Dallas en 25 minutos." },
    ],
  },
  stays:[
    { name:"The Joule Dallas", area:"Downtown Dallas / Main Street", price:"$$$", priceCAD:"Precio estimado en periodo mundialista: $300–500 USD/noche", tags:["Arte contemporáneo","Piscina rooftop","Acceso DART"], note:"El hotel más distinguido del downtown histórico: arte contemporáneo en cada piso, piscina en el rooftop con extensión sobre la fachada y CBD Provisions — una de las mejores mesas del centro. Acceso al DART desde la estación West End.", best_for:"Hotel boutique", url:"https://booking.stay22.com/lagomplan/uZmVz5IprZ", archetypes: ['Parejas'] },
    { name:"Rosewood Mansion on Turtle Creek", area:"Uptown / Turtle Creek", price:"$$$", priceCAD:"Precio estimado en periodo mundialista: $280–450 USD/noche", tags:["Mansión restaurada","143 habitaciones","Jardines"], note:"La mejor relación calidad-atmósfera de Uptown: 143 habitaciones en una mansión restaurada con jardines y restaurante propio. Más íntimo que los grandes hoteles de cadena.", best_for:"Pareja", url:"https://booking.stay22.com/lagomplan/C8gUu3RSPW", archetypes: [] },
    { name:"W Dallas — Victory", area:"Victory Park / AAC District", price:"$$$$", priceCAD:"Precio estimado en periodo mundialista: $380–750 USD/noche", tags:["Piscina","Spa","DART Victory Station"], note:"En el complejo de entretenimiento de Victory Park, a pasos del American Airlines Center. Piscina, spa y servicio Whatever/Whenever. Acceso al DART desde la estación Victory — misma línea que lleva al aeropuerto DFW.", best_for:"Lujo", url:"https://booking.stay22.com/lagomplan/TOp2Hl1Ouh", archetypes: ['Parejas', 'Bienestar'] },
  ],
...
export const en: CityGuide = {
  ...
  stayNeighborhoods:{
    intro:"Dallas hosts more matches than any other city in the tournament, with the clearest logistical problem: the stadium is in Arlington, a fully independent city between Dallas and Fort Worth, with no metro and no city-scale official shuttle bus. Picking the base neighborhood has to solve transit realistically.",
    items:[
      { kind:"recommended", title:"Recommended base: Uptown Dallas / Knox-Henderson", body:"Uptown is Dallas's densest dining and lodging neighborhood, with access to the McKinney Avenue Trolley (free streetcar that connects with the Convention Center and the DART transit system). From Uptown to Arlington by Uber on a normal day: 35–45 minutes. On match day with surge pricing: 50–70 minutes. Knox-Henderson, adjacent, has the city's best independent restaurants." },
      { kind:"alternative", title:"Tactical option: Las Colinas / Irving", body:"For the fan who prioritizes stadium access over urban atmosphere, Las Colinas and Irving sit in the corridor between DFW and Arlington — 20 minutes from the stadium by car without match-day traffic. Well-equipped chain hotels, fast access to DFW via DART Orange Line, and a shorter return than Dallas downtown on match days. Without Uptown's neighborhood feel, but without the post-match traffic." },
      { kind:"alternative", title:"For Argentine fans: Garland / Richardson (Latin American community)", body:"The Garland Road corridor and the Richardson Community hold the metro's largest concentration of Latin American restaurants — and an Argentine community that on match days turns the neighborhood bars into something very close to La Boca. The DART Blue Line connects Richardson with downtown Dallas in 25 minutes." },
    ],
  },
  stays:[
