...
export const en: CityGuide = {
  ...
  experiences:[
    { title:"Tequila — day trip", duration:"Full day", desc:"The town of Tequila sits 65 km northeast of Guadalajara, reachable by bus from the Central de Autobuses in under 90 minutes, or on the weekend Tequila Express (includes distillery visit and tasting). Herradura and Casa Cuervo offer tours by advance booking; Fortaleza is the craft option most recommended for anyone who wants to understand the process before drinking. Return by 7pm leaves time for a night match in the city.", type:"Day trip", affiliateLink:"AFFILIATE_LINK_GDL_TEQUILA", affiliateLabel:"See Tequila tours" },
    { title:"Tlaquepaque + Tonalá", duration:"Full day", desc:"Two neighboring municipalities with distinct identities: Tlaquepaque is galleries, talavera ceramics, and the state's best Folk Art Market; Tonalá is wholesale, where artisans sell without middlemen and prices run considerably lower. For the traveler short on time: Tlaquepaque in the morning, Tonalá in the afternoon. Both 20 minutes from downtown by Uber.", type:"Cultural", affiliateLink:"AFFILIATE_LINK_GDL_TLAQUEPAQUE", affiliateLabel:"Tlaquepaque crafts tour" },
    { title:"Lake Chapala / Ajijic", duration:"Full day", desc:"Lake Chapala, 45 km south, is Mexico's largest. The town of Ajijic on the north shore has lakeside restaurants that work as the perfect antidote to the World Cup rhythm. Direct bus from the Central Camionera Sur in 55 minutes. Ideal as a rest day between matches — especially between June 18 and 23.", type:"Nature", affiliateLink:"AFFILIATE_LINK_GDL_CHAPALA", affiliateLabel:"Lake Chapala tours" },
  ],
