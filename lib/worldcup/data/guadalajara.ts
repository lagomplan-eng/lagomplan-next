...
export const es: CityGuide = {
  ...
  stays:[
    { name:"Hotel Demetria", area:"Providencia", price:"$$$", priceCAD:"Precio estimado en periodo mundialista: $150–250 USD/noche", tags:["Boutique","Cocina jaliscience","Parque Metropolitano"], note:"Dieciséis habitaciones, restaurante con cocina jaliscience seria y una estética que evita todos los clichés del boutique latinoamericano. A cuatro cuadras del Parque Metropolitano y con acceso rápido al BRT.", best_for:"Hotel boutique", url:"https://booking.stay22.com/lagomplan/dDSl_dn7B8", archetypes: ['Parejas'] },
    { name:"Hostal Nube Mia", area:"Centro Histórico", price:"$", priceCAD:"Precio estimado en periodo mundialista: $15–25 USD/noche en dorm · $50–80 USD/noche habitación privada.", tags:["Presupuesto","Habitaciones privadas","Cocina comunitaria"], note:"Frente al Parque de la Revolución, a 150 metros del metro y a diez minutos caminando del Fan Fest. Nuevo, limpio, seguro y con terraza con vistas al centro. El hostal que hace bien lo básico sin intentar ser otra cosa.", best_for:"Presupuesto", url:"https://www.booking.com/hotel/mx/nube-mia-hostel.es-ar.html?label=Low_CPA_Spanish_ES_MX_21457807345-N4i9yluJvJB1JPt419GhKgS217289930788%3Apl%3Ata%3Ap1%3Ap2%3Aac%3Aap%3Aneg&gclid=CjwKCAjwzevPBhBaEiwAplAxvnE_t9Sj9dBVPSfJ8Zgbs0FjN-avh7fXYQ2sWf8vK_fTXB_yw_W2vhoC6kAQAvD_BwE&aid=318615", archetypes: ['Parejas'] },
    { name:"Hyatt Regency Guadalajara", area:"López Mateos / Minerva", price:"$$$$", priceCAD:"Precio estimado en periodo mundialista: $280–480 USD/noche", tags:["Cadena internacional","BRT cercano","Minerva"], note:"En el corredor financiero de la ciudad, con acceso fácil al BRT y a la red de restaurantes de Zapopan. Infraestructura completa de cadena internacional — a precios que, comparados con CDMX en periodo mundialista, se sienten casi razonables.", best_for:"Lujo", url:"https://booking.stay22.com/lagomplan/MVkiwMYOZS", archetypes: ['Parejas'] },
  ],
