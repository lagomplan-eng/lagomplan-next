...
export const en: CityGuide = {
  ...
  stayNeighborhoods:{
    intro:"Atlanta is a city built for the car — but the World Cup changes that, in part. Mercedes-Benz Stadium sits downtown, connected to MARTA, and the most interesting neighborhoods to stay in are within reasonable distance of the line.",
    items:[
      { kind:"recommended", title:"Recommended base: Midtown Atlanta", body:"The Peachtree Street corridor in Midtown has the city's best concentration of boutique hotels, chef-driven restaurants, and bars, with direct access to MARTA (Midtown and Arts Center stations on the Red/Gold line). To the stadium: 15 minutes by metro, no transfer. For the fan who wants to live Atlanta between matches without depending on a car, Midtown is the most complete base." },
      { kind:"alternative", title:"Character pick: Inman Park / Ponce City Market", body:"Atlanta's most Victorian neighborhood, with the city's best selection of independent restaurants. Ponce City Market — a market inside a former Sears distribution building — has more than a hundred shops and restaurants under one roof. MARTA access via King Memorial Station (East/West line, transfer at Five Points for the stadium). Genuine atmosphere, prices below Midtown." },
      { kind:"alternative", title:"For African and Spanish fans: Doraville / Buford Highway", body:"The Buford Highway corridor northeast of Atlanta concentrates the city's greatest culinary diversity — Korean, Chinese, Vietnamese, Ethiopian, and Mexican cuisine within a ten-kilometer radius. Doraville also has the most active African community in the metro area. Access via MARTA Gold line (Doraville Station, end of the line). For the fan who wants to eat well and spend little between the June 15 and June 21 matches." },
      { kind:"avoid", title:"Avoid as a base: Downtown immediately around the stadium", body:"Downtown Atlanta outside the CNN Center complex and Centennial Olympic Park has blocks without real neighborhood life. Convenient in theory for the stadium; frustrating as a multi-day base. Midtown is ten minutes away on MARTA and has everything downtown doesn't." },
    ],
  },
  stays:[
