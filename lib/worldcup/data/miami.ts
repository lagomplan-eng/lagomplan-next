...
export const en: CityGuide = {
  ...
  experiences:[
    { title:"South Beach + Art Deco District", duration:"Morning or afternoon", desc:"South Beach's Art Deco district has the largest concentration of preserved Art Deco architecture in the world: 800 buildings from 1920–1940 between Ocean Drive and Collins Avenue. For the off day between June 15 and 21, South Beach by bike combines historic architecture, beach, and access to the best bars in the area.", type:"Beach", affiliateLink:"", affiliateLabel:"Rent a bike" },
    { title:"Wynwood Art District", duration:"Afternoon", desc:"Wynwood has the largest concentration of outdoor mural art in North America: more than 50 murals by international artists within a ten-block radius. For the off day before Colombia's match, Wynwood in the afternoon is the best plan between matches.", type:"Art", affiliateLink:"", affiliateLabel:"See info" },
    { title:"Everglades — day trip", duration:"Full day", desc:"The Everglades are 45 minutes west of Miami. The national park has airboat, kayak, and walking excursions among alligators, manatees, and more than 300 bird species. For the fan with two days off between June 15 and 24, it's the experience most radically different from the tournament.", type:"Nature", affiliateLink:"", affiliateLabel:"Book airboat tour" },
    { title:"Key Biscayne + Rickenbacker Causeway", duration:"Afternoon", desc:"Key Biscayne island is 15 minutes from downtown Miami. It has the quietest, least crowded beaches in the metro area. For the fan who wants beach without the crowds of South Beach before the Semifinal.", type:"Quiet beach", affiliateLink:"", affiliateLabel:"See options" },
  ],
  lagomTips:[
