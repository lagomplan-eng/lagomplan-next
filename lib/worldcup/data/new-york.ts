...
export const es: CityGuide = {
  ...
  matches:[
    ...
    { id:"m2", date:"16 Jun", day:"Mar", time:"15:00 ET", teams:[{name:"Francia",flag:"🇫🇷"},{name:"Senegal",flag:"🇸🇳"}], stadium:"MetLife Stadium", tag:"Grupo I", highlight:false },
  ...
  manifesto:{
    stadiumInfo:[
      ...
      { label:"Nota importante", value:"MetLife Stadium está en East Rutherford, Nueva Jersey — no en la ciudad de Nueva York. El estadio no tiene acceso por subway. La única ruta de tránsito público es NJ Transit desde Penn Station." },
  ...
  vibe:{
    ...
    lagomNote:"El 13 de junio (Brasil vs. Marruecos) y el 19 de julio (Final) son las fechas de mayor demanda de toda la sede — y posiblemente del torneo completo. Reserva alojamiento con meses de anticipación — y si no puedes, considera Jersey City, Hoboken o Newark como bases alternativas a Manhattan.",
  },
  stayNeighborhoods:{
  ...
  food:[
    ...
    { dish:"Pizza por rebanada", where:"Manhattan — el ritual obligatorio de la ciudad; West Village y Nolita tienen la mayor densidad de referencias", price:"$", type:"Ritual" },
    { dish:"Desayuno de barrio", where:"Upper West Side y Brooklyn — bagels con lox, café de especialidad; el mejor desayuno de Nueva York no tiene nombre propio", price:"$", type:"Local" },
  ],
  experiences:[
  ...
  lagomTips:[
    ...
    "El 13 de junio (Brasil vs. Marruecos) y el 19 de julio (Final) son las dos fechas de mayor demanda de toda la sede — y posiblemente del torneo completo.",
...
export const en: CityGuide = {
  ...
  matches:[
    ...
    { id:"m2", date:"Jun 16", day:"Tue", time:"15:00 ET", teams:[{name:"France",flag:"🇫🇷"},{name:"Senegal",flag:"🇸🇳"}], stadium:"MetLife Stadium", tag:"Group I", highlight:false },
  ...
  manifesto:{
    stadiumInfo:[
      ...
      { label:"Important note", value:"MetLife Stadium is in East Rutherford, New Jersey — not in New York City. The stadium has no subway access. The only public-transit route is NJ Transit from Penn Station." },
  ...
  vibe:{
    ...
    lagomNote:"June 13 (Brazil vs. Morocco) and July 19 (Final) are the host city's peak-demand dates — and possibly the entire tournament's. Book accommodation months ahead — if you can't, consider Jersey City, Hoboken, or Newark as alternative bases to Manhattan.",
  },
  stayNeighborhoods:{
  ...
  food:[
    ...
    { dish:"Pizza by the slice", where:"Manhattan — the mandatory ritual; the West Village and Nolita have the highest density of neighborhood references", price:"$", type:"Ritual" },
    { dish:"Neighborhood breakfast", where:"Upper West Side and Brooklyn — bagels, lox, specialty coffee; New York's best breakfast has no single name", price:"$", type:"Local" },
  ],
  experiences:[
