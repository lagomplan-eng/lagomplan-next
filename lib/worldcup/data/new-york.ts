...
export const en: CityGuide = {
  ...
  experiences:[
    { title:"MoMA + High Line + Chelsea", duration:"Half to full day", desc:"The Museum of Modern Art in Midtown holds the world's most important permanent contemporary-art collection — a Picasso, a Dalí, and a Frida Kahlo in the same room. Admission $30 USD; Fridays 4–8pm are free. For the afternoon, the High Line (the elevated linear park over the Chelsea rail tracks) connects the gallery district with Hudson Yards in a 2.5-kilometer walk.", type:"Art", affiliateLink:"", affiliateLabel:"See info" },
    { title:"Flushing (Queens) — the real Chinatown", duration:"Half day", desc:"Manhattan's Chinatown is touristy. Flushing's, in Queens, is North America's largest and most authentic: five-floor covered markets, restaurants from every region of China, imported-ingredient stores, and a neighborhood energy with nothing to sell the casual visitor. Subway 7 from Times Square (30 minutes). Pair with the Fan Zone at the USTA Billie Jean King Center.", type:"Neighborhood", affiliateLink:"", affiliateLabel:"See subway" },
    { title:"Staten Island Ferry + Smorgasburg", duration:"Morning or full day", desc:"The Staten Island ferry is free, runs 24 hours, and offers the best view of the Statue of Liberty and Lower Manhattan skyline from the water — no admission, no booking. For the Saturday between matches, Smorgasburg in Williamsburg (9am–4pm) is the city's most varied street-food market: 100 independent vendors on Marcy Avenue.", type:"No tourism", affiliateLink:"", affiliateLabel:"See Smorgasburg" },
    { title:"Brooklyn — Williamsburg + Park Slope", duration:"Full day", desc:"Brooklyn has the best neighborhood-quality / price ratio in all of New York. Williamsburg: Smorgasburg, independent design shops, and the city's best coffee. Park Slope: brownstones, Prospect Park, family cafes. Subway L or F connects both.", type:"Neighborhood", affiliateLink:"", affiliateLabel:"See options" },
  ],
  lagomTips:[
