        ...
        {nextCheck ? (
          <div className="flex items-center gap-3 pl-5 border-l border-white/10 shrink-0 max-w-[340px]">
            ...
            <button
              ...
              className="font-sans text-[12px] font-semibold text-[#0F3A33] bg-[#A8C4BE] hover:bg-[#C0D5CE] transition-colors px-3.5 py-2 rounded-full whitespace-nowrap shrink-0"
            >
              {ctaLabel}
            </button>
          </div>
